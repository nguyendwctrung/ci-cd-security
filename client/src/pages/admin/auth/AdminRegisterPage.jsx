...
function RegistrationForm({ onNext, setSharedData }) {
  ...
  useEffect(() => {
    ...
    validator.onSuccess((event) => {
      ...
      fetch(`${API_URL}/api/admin/auth/signup`, {
        method: "POST",
...
function OTPVerificationForm({ sharedData, onSuccess }) {
  ...
  const handleSubmit = (e) => {
    ...
    setIsLoading(true);
    fetch(`${API_URL}/api/admin/auth/verify-otp-signup`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  const handleResendOTP = () => {
    ...
    fetch(`${API_URL}/api/admin/auth/resend-otp-signup`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      ...
      <div className="w-full max-w-md">
        ...
        {step === 1 && (
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">
              Register for admin access to PokeMap
            </p>
          </div>
        )}
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 shadow-xl border border-white/20">
          ...
          <div className="flex items-center justify-center gap-4 mb-8">
            ...
            <div
              className={`w-16 h-1 rounded ${step >= 2 ? "bg-purple-500" : "bg-white/20"}`}
            ></div>
            <div
          ...
          {step === 2 && (
            <OTPVerificationForm sharedData={sharedData} onSuccess={() => {}} />
          )}
        </div>
